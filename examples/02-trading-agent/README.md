...
Use a Sandbox-scoped CDP key with Trade ON / Transfer OFF while testing. A Coinbase error such as `INSUFFICIENT_FUND` on a zero-funds account is expected and correct.
